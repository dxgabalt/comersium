      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'LogoWall')
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'searchComersiums')
              : const SearchComersiumsWidget(),
        ),
        FFRoute(
          name: 'waitingPage',
          path: '/waitingPage',
          builder: (context, params) => const WaitingPageWidget(),
        ),
        FFRoute(
          name: 'SettingsPage',
          path: '/settingsPage',
        ...
        FFRoute(
          ...
          builder: (context, params) => const RegisterBusinessWidget(),
        ),
        FFRoute(
          name: 'ProfileBusiness',
          path: '/profileBusiness',
          asyncParams: {
            'businessData': getDoc(['Commerce'], CommerceRecord.fromSnapshot),
          },
